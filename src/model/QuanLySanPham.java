...
public class QuanLySanPham {
	...
	// them san pham: nguoi dung lua chon them sach hoac them dia phim hoac them dia
	// nhac
	...
	public void themDiaPhim() {
		...
		try {
			...
			DiaPhim diaPhim = new DiaPhim(maSp, tenSP, namPhatHanh, soLuong, tenSP, giaBuon, giaBan, soLuong, daoDien,
					dienVien);
	...
	public void hienThiSach() {
		...
		String header = String.format("%s%15s%30s%15s%15s%15s%15s%15s", "Ma san pham" + "Ten san pham" + "Nam phat hanh"
				+ "So luong" + "Gia buon" + "Gia ban" + "Tac gia" + "Nha xuat ban");
		System.out.println(header);
		for (Map.Entry<String, Sach> entry : dsSach.entrySet()) {
			String row = String.format("%s%15s%30s%15s%15s%15s%15s%15s", entry.getValue().getMaSp(),
	...
	public void hienThiDiaPhim() {
		System.out.println("Danh sach san pham");
		String header = String.format("%s%15s%30s%15s%15s%15s%15s%15s", "Ma san pham" + "Ten san pham" + "Nam phat hanh"
				+ "So luong" + "Gia buon" + "Gia ban" + "Dao dien" + "Dien vien");
		System.out.println(header);
	...
	public void hienThiDiaNhac() {
		System.out.println("Danh sach san pham");
		String header = String.format("%s%15s%30s%15s%15s%15s%15s%15s", "Ma san pham" + "Ten san pham" + "Nam phat hanh"
				+ "So luong" + "Gia buon" + "Gia ban" + "Ca sy" + "Danh sach bai hat");
		System.out.println(header);
